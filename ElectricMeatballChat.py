...
class ElectricMeatballChat:
    """
    ElectricMeatballChat
    ---
    A singleton class representing the ElectricMeatballChat instance.
    ...
    def __new__(self):
        if self.__instance is None:
            self.__instance = super(ElectricMeatballChat, self).__new__(self)
        return self
    ...
    def initialize(self) -> None:
        ...
        initialize
        ---
        Initializes the ElectricMeatballChat instance by loading configuration data from EMConfig.json.
    ...
    def getInstance(self):
        """
        Get the instance of ElectricMeatballChat.

        Returns:
            ElectricMeatballChat: The instance of ElectricMeatballChat.
        """
